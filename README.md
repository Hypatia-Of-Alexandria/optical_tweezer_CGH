...
├── compare_three_way.py       # 3-way comparison
├── train_vanillanet.py        # Training vanilla net
...
|--------|-------------|------|------|
| **Gerchberg-Saxton** | Iterative phase retrieval algorithm | Well-established, popular | Slower than neural network |
| **Gradient Descent** | Direct optimization of phase patterns | Direct optimisation | Slow, can get stuck in local minima |
| **Neural Network** | Learned mapping from target to phase | Very fast inference | Less interpretable |
...
- **Loss Function**: Combination of $inefficiency + \lambda  non-uniformity$

### Evaluation Metrics
- **Efficiency**: Fraction of total power in target region
